...
"""
        ...
        if job.container_id:
            ...
            if package_hash not in executor.containers:
                # Use secure container options for webhook execution
                secure_options = executor._get_secure_container_options()
                ...
                container = docker_client.containers.run(
                    ...
                    cpu_period=100000,
                    cpu_quota=50000,
                    network="none",  # Network isolation for webhook execution
                    read_only=True,
                    tmpfs=tmpfs,
